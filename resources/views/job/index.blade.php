            ...
            <x-card-horizontal class="p-4">
                <div class="flex justify-between">
                    <div class="flex gap-3 max-w-[600px] w-full">
                        ...
                        <div>
                            <h3 class="line-clamp-1 font-open-sans font-semibold text-xl">{{ Str::ucfirst($job->title) }}
                            </h3>
                ...
                <div class="max-w-[690px] w-full">
                    <p class="mt-5 font-open-sans font-semibold text-sm line-clamp-2">{{ $job->description }}</p>
