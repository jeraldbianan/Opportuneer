<section class="container flex justify-center items-center gap-[72px] py-[90px]">
    <div class="flex flex-col w-full max-w-[466px]">
        <h2 class="font-montserrat text-4xl font-semibold !leading-[130%]">
            <span class="font-black text-dark-blue">Empowering</span> Your Career
            Journey
        </h2>
        <p class="mt-6 font-open-sans text-base !leading-[160%]">
            From job discovery to application support, we provide the tools you
    ...
    <div class="relative h-auto max-h-full w-full max-w-[622px]">
        <img src="images/hero-image-2.png" alt="Hero image" class="object-contain">
    </div>
</section>
